...
lint: ## check style with flake8
	flake8 chibi_site tests

coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_site setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_site.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_site
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics chibi_site tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes chibi_site tests
